    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-space-between">
                        <h4 class="mb-4 mb-sm-0 card-title">Tambah Data Penyewa</h4>
                        <nav aria-label="breadcrumb" class="ms-auto">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item my-auto" aria-current="page">
                                    <span class="badge fw-medium fs-2 bg-primary-subtle text-primary-emphasis"> Tambah Penyewa </span>
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card card-body">
                ...
                <hr class="mb-4">
                <form id="penyewaCreateForm">
                    <div class="mb-3">
                        <label for="namaPenyewa" class="form-label">Nama Penyewa</label>
                        <input type="text" class="form-control" name="namaPenyewa" id="namaPenyewa" placeholder="Erling Haaland" required>
                    </div>
                    <div class="mb-3">  
                        <label for="nomorTelepon" class="form-label">Nomor Telepon</label>
                        <input type="text" class="form-control" name="nomorTelepon" id="nomorTelepon" placeholder="081311112222" required>
                    </div>
                    <div class="mb-3">  
                        <label for="alamat" class="form-label">Alamat</label>
                        <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Norway" required>
                    </div>
                    ...
                    <input type="hidden" name="simpan" value="penyewaCreate">
